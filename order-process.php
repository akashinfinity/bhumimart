...
// 			echo $country_code;
///////////////////////////////////////////////////////////////////////////
          $sql1 = "select delivery_time from orders where id=".$order_id;
			$db->sql($sql1);
			$res2 = $db->getResult();
       
			$subject = "Order placed successfully";
			$message = "Namaste ".ucwords($res[0]['name']).", <br> Your order is <b>successfully</b> placed.<br>";////////
			$message .= "<b>Order ID :</b> #".$response['order_id']./////////
			$message.="<br>";
			$message.="Your expected delivery time is : ".$res2;
			$message.="<br>";
			$message.='This delivery is boosted and will reach you soon.';
			$message.="<br><br>";
			$message.="For any doubts, feel free to reach us at: ";
			$message.="<br>";
			$message.="Phone : <b>+91-854209981</b><br>";
			$message.="Email : <b>support@bhumimart.in</b><br><br> ";
			$message.="Thank you for placing an order with us!<br>";
			$message.="Regards,<br>";
			$message.="Team <b>Bhumi</b><br>";
			$message.="You'll receive future updates on your email";
			
			//$message = "Namaste ".ucwords($res[0]['name']).", <br> Your order is successfully placed. Your order summaries are as followed:<br><br>";///
...
if(isset($_POST['get_orders']) && isset($_POST['user_id'])) {
	...
	$user_id = $db->escapeString($function->xss_clean($_POST['user_id']));
	$limit = (isset($_POST['limit']) && !empty($_POST['limit']) && is_numeric($_POST['limit']))?$db->escapeString($function->xss_clean($_POST['limit'])):10000;
...
if(isset($_POST['update_order_status']) && isset($_POST['id'])) {
    ...
    // 		echo $country_code;
    		...
    		$message = "Namaste ".ucwords($res_user[0]['name']).", Here is the new update on your order for the order ID : #".$id.". Your order has been ".ucwords($postStatus).". Please take a note of it.";
    		$message .= "Thank you for using our services!You will receive future updates on your order via Email! ";
    		$message .= "Regards, Team Bhumi";
		...
		if($postStatus=='cancelled')
		{
			$message1 = "Namaste ".ucwords($res[0]['name']).", <br> We've <b>cancelled</b> your order #".$response['order_id']." successfully.<br>";////////
			$message1.="If any amount is deducted, it'll be reverted back very soon.";
			$message1.="<br>";
			$message1.='Wish to see you soon.';
			$message1.="<br><br>";
			$message1.="For any doubts, feel free to reach us at: ";
			$message1.="<br>";
			$message1.="Phone : <b>+91-854209981</b><br>";
			$message1.="Email : <b>support@bhumimart.in</b><br><br> ";
			$message1.="Regards,<br>";
			$message1.="Team <b>Bhumi</b><br>";
			$message1.="You'll receive future updates on your email";
			
			send_email($to,$subject,$message1);
		}
		else if($postStatus=='delivered')
		{
		   $message2 = "Namaste ".ucwords($res[0]['name']).", <br> We've successfully <b>delivered</b> your order #".$response['order_id']." <br>";////////
			$message2.="It was a nice time serving you and we wish to meet again very soon.";
			$message2.="<br>";
			$message2.='The <b>invoice</b> of your order is attached here.';
			$message2.="<br><br>";
			$message2.="For any doubts, feel free to reach us at: ";
			$message2.="<br>";
			$message2.="Phone : <b>+91-854209981</b><br>";
			$message2.="Email : <b>support@bhumimart.in</b><br><br> ";
			$message2.="Regards,<br>";
			$message2.="Team <b>Bhumi</b><br>";
			$message2.="You'll receive future updates on your email";
         send_email($to,$subject,$message2);		
		}
		else
		{
    		send_email($to,$subject,$message);
